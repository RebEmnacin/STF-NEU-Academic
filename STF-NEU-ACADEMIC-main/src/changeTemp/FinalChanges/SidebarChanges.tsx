...
2. to apply admin profile linking in sidebar, need to update setView logic in PortalContext to recognize "admin-profile" and route to AdminProfile screen

TO BE CHANGED/ TO DO:
1. Put numbering in the announcement sidebar tab depending how many unread announcements there are (can be done by adding a new state in PortalContext to track unread announcements, and then displaying that count as a badge on the "Announcements" nav item in the sidebar)
*/
